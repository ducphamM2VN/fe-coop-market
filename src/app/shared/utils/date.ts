...
export class DateUtil {
     ...
     * @param dateTo
     */
    static checkDateFromDateTo(dateFrom: string, dateTo: string) {
     ...
     * @param newDate
     */
    static convertDateTimeToUTC(newDate: string) {
     ...
     * @param yearNumber
     */
    static addYearToDate(value: string, yearNumber: number) {
     ...
     * @param monthNumber
     */
    static addMonthToDate(value: string, monthNumber: number) {
        const date = new Date(value);
