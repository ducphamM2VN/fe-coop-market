...
import { BaseCategoriesFormComponent } from '../../../data-access/base/base-components-form.component';
...
export class FormNganhHangComponent extends BaseCategoriesFormComponent<ICategories> implements OnInit {
