...
import { BaseDangKyListComponent } from '../../data-access/base/base-components-list.component';
...
export class ComponentNganhHangComponent extends BaseDangKyListComponent<ICategories> implements OnInit {
