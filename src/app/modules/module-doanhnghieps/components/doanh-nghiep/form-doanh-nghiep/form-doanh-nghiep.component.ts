...
import { BaseDoanhNghiepsFormComponent } from "../../../data-access/base/base-components-form.component";
import { IDoanhNghieps, IMoHinhKinhDoanh } from "../../../data-access/models/doanhnghiep.model";

@Component({
    selector: "ngx-form-doanh-nghiep",
    templateUrl: "./form-doanh-nghiep.component.html",
})
export class FormDoanhNghiepComponent extends BaseDoanhNghiepsFormComponent<IDoanhNghieps> implements OnInit {
    url: String = UrlModuleDoanhNghieps.ROUTE_DOANHNGHIEPS.DOANH_NGHIEP;
